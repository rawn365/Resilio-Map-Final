# ═══════════════════════════════════════════════════════════════════════════════
# RESILIO-MAP – SAFE WORKING VERSION (No future rasters required)
# ═══════════════════════════════════════════════════════════════════════════════
...
/* Fix expander toggle showing icon label text */
...
# ═══════════════════════════════════════════════════════════════════════════════
# RISK ASSESSMENT PAGE (SAFE VERSION – NO FUTURE RASTERS REQUIRED)
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    if st.session_state.dash_generated and st.session_state.dash_sp_key:
        ...
        refugia_245, gained_245, maintained_245, lost_245 = stability_numbers(sp_key, 'ssp245')
        refugia_585, gained_585, maintained_585, lost_585 = stability_numbers(sp_key, 'ssp585')
        ...
        with left_col:
            ...
            with m1: st.markdown(f"""<div style="background:#eaf4ed;border-radius:8px;padding:12px;text-align:center;"><div class="fraunces-number" style="font-size:24px;color:#1e6b3c;">{refugia_245:,}</div><div style="font-size:10px;">Refugia (km²)</div></div>""", unsafe_allow_html=True)
            with m2: st.markdown(f"""<div style="background:#eff6ff;border-radius:8px;padding:12px;text-align:center;"><div class="fraunces-number" style="font-size:24px;color:#2563eb;">{gained_245:,}</div><div style="font-size:10px;">Gained (km²)</div></div>""", unsafe_allow_html=True)
            with m3: st.markdown(f"""<div style="background:#f7f9f7;border-radius:8px;padding:12px;text-align:center;"><div class="fraunces-number" style="font-size:24px;color:#8fa893;">{maintained_245:,}</div><div style="font-size:10px;">Maintained (km²)</div></div>""", unsafe_allow_html=True)
            with m4: st.markdown(f"""<div style="background:#fef2f2;border-radius:8px;padding:12px;text-align:center;"><div class="fraunces-number" style="font-size:24px;color:#dc2626;">{lost_245:,}</div><div style="font-size:10px;">Lost (km²)</div></div>""", unsafe_allow_html=True)
        ...
        with right_col:
            ...
            st.markdown("**Habitat Metrics**")
            m1,m2,m3,m4 = st.columns(4)
            with m1: st.markdown(f"""<div style="background:#eaf4ed;border-radius:8px;padding:12px;text-align:center;"><div class="fraunces-number" style="font-size:24px;color:#1e6b3c;">{refugia_585:,}</div><div style="font-size:10px;">Refugia (km²)</div></div>""", unsafe_allow_html=True)
            with m2: st.markdown(f"""<div style="background:#eff6ff;border-radius:8px;padding:12px;text-align:center;"><div class="fraunces-number" style="font-size:24px;color:#2563eb;">{gained_585:,}</div><div style="font-size:10px;">Gained (km²)</div></div>""", unsafe_allow_html=True)
            with m3: st.markdown(f"""<div style="background:#f7f9f7;border-radius:8px;padding:12px;text-align:center;"><div class="fraunces-number" style="font-size:24px;color:#8fa893;">{maintained_585:,}</div><div style="font-size:10px;">Maintained (km²)</div></div>""", unsafe_allow_html=True)
            with m4: st.markdown(f"""<div style="background:#fef2f2;border-radius:8px;padding:12px;text-align:center;"><div class="fraunces-number" style="font-size:24px;color:#dc2626;">{lost_585:,}</div><div style="font-size:10px;">Lost (km²)</div></div>""", unsafe_allow_html=True)
